...
- [x] Complete strict Phase 12 audit covering env strategy, secure storage, OTP, notifications, deep links, referral attribution, and analytics/crash SDK boundaries
