...
import habitgoldmobile.composeapp.generated.resources.home_screen_footer_badge_insured_toast
import habitgoldmobile.composeapp.generated.resources.home_screen_footer_badge_physical_toast
import habitgoldmobile.composeapp.generated.resources.home_screen_footer_badge_vault_toast
...
fun HomeScreen(
    ...
    val physicalGoldInfoMessage = stringResource(Res.string.home_screen_footer_badge_physical_toast)
    val insuredGoldInfoMessage = stringResource(Res.string.home_screen_footer_badge_insured_toast)
    val vaultInfoMessage = stringResource(Res.string.home_screen_footer_badge_vault_toast)
                        ...
                        dashboard != null && dashboard.totalGoldBalanceGrams <= 0.0 -> {
                            ...
                            item("home-support-footer") {
                                HomeSupportFooter(
                                    ...
                                    onPhysicalInfoClick = {
                                        scope.launch { snackbarHostState.showSnackbar(physicalGoldInfoMessage) }
                                    },
                                    onInsuredInfoClick = {
                                        scope.launch { snackbarHostState.showSnackbar(insuredGoldInfoMessage) }
                                    },
                                    onVaultInfoClick = {
                                        scope.launch { snackbarHostState.showSnackbar(vaultInfoMessage) }
                                    },
                                )
                            }
                        }
