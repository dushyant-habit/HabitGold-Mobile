...
sealed interface ProfileDestination {
    ...
    data object Security : ProfileDestination
    data object HelpCenter : ProfileDestination
    data object VpaList : ProfileDestination
    data class ContactUs(val seedSummary: com.habit.gold.feature.profile.domain.model.ProfileSummary? = null) : ProfileDestination
