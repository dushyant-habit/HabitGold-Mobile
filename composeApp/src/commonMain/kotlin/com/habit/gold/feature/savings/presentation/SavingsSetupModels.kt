...
internal enum class SavingsFrequency(
    ...
    Daily(
        ...
        quickAmounts = listOf(
            ...
            SavingsQuickAmount(100, "Popular"),
            SavingsQuickAmount(150),
            SavingsQuickAmount(200),
            SavingsQuickAmount(500, "Top 5%"),
        ),
    ),
    Weekly(
        routeValue = "Weekly",
        ...
        maxAmount = 15000,
        quickAmounts = listOf(
            SavingsQuickAmount(100),
            SavingsQuickAmount(300, "Popular"),
            SavingsQuickAmount(500),
            SavingsQuickAmount(1000),
            SavingsQuickAmount(1500, "Top 5%"),
        ),
    ),
    Monthly(
        routeValue = "Monthly",
